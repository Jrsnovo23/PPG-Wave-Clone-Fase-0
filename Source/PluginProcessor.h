...
#include "Synth/PlaceholderSineVoice.h"
...
public:
    ...
    //==============================================================
    // Estado del plugin dentro del proyecto de Ableton Live (Fase 1: solo
    // parámetros vía APVTS; el formato completo de presets llega en Fase 6).
